...
export function HeroSection() {
  ...
  const scrollToContent = () => {
    const nextSection = document.getElementById('at-a-glance');
    if (nextSection) {
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        <button
          ...
          className="mt-6 text-warm-brown hover:text-espresso transition-colors flex items-center gap-1 text-sm font-medium"
        >
          Browse this issue
